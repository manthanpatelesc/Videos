...
package com.liuzhenlin.videoplayer.view.swiperefresh;
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
    ...
    private OnRequestDisallowInterceptTouchEventCallback mRequestDisallowInterceptTouchEventCallback;

    public void setOnRequestDisallowInterceptTouchEventCallback(
            @Nullable OnRequestDisallowInterceptTouchEventCallback callback) {
        mRequestDisallowInterceptTouchEventCallback = callback;
    }

    public interface OnRequestDisallowInterceptTouchEventCallback {
        boolean shouldPassUpToRequestDisallowInterceptTouchEvent();
    }
}
