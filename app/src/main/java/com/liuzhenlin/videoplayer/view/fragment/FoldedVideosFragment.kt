...
import com.liuzhenlin.videoplayer.view.fragment.VideoListFragment.Companion.PAYLOAD_CHANGE_CHECKBOX_VISIBILITY
import com.liuzhenlin.videoplayer.view.fragment.VideoListFragment.Companion.PAYLOAD_CHANGE_ITEM_LPS_AND_BG
import com.liuzhenlin.videoplayer.view.fragment.VideoListFragment.Companion.PAYLOAD_REFRESH_CHECKBOX
import com.liuzhenlin.videoplayer.view.fragment.VideoListFragment.Companion.PAYLOAD_REFRESH_CHECKBOX_WITH_ANIMATOR
import com.liuzhenlin.videoplayer.view.fragment.VideoListFragment.Companion.PAYLOAD_REFRESH_ITEM_NAME
import com.liuzhenlin.videoplayer.view.fragment.VideoListFragment.Companion.PAYLOAD_REFRESH_VIDEO_PROGRESS_DURATION
...
class FoldedVideosFragment : SwipeBackFragment(), View.OnClickListener, View.OnLongClickListener,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (ViewCompat.getLayoutDirection(mActivity.window.decorView) == ViewCompat.LAYOUT_DIRECTION_RTL) {
    ...
    override fun onDestroyView() {
        ...
        if (mLoadDirectoryVideosTask != null) {
            mLoadDirectoryVideosTask!!.cancel(false)
    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.bt_selectAll -> {
                if (mSelectAllButton.text == STRING_SELECT_ALL) {
    ...
    private fun onVideoCheckedChange() {
        ...
        when (checkedVideosCount) {
            mVideos.size -> mSelectAllButton.text = STRING_SELECT_NONE
            else -> mSelectAllButton.text = STRING_SELECT_ALL
        }
